...
const {getRide, getRides, getRidesByDriverId, getPassengerRidesByDriverId} = require("../controllers/getRideController");
...
router.get("/get-passenger-rides/:driver", authMiddleware, getPassengerRidesByDriverId);
